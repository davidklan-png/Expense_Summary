...
TRANSLATIONS = {
    "en": {
        ...
        "upload": {
            ...
            "error_too_many_files": "⚠️ Upload up to {max_files} CSV files at a time.",
            "error_file_too_large": "⚠️ These files exceed {max_mb} MB: {filenames}",
            "error_total_too_large": "⚠️ Upload batch is too large. Keep total CSV size under {max_mb} MB.",
        ...
        "process": {
            ...
            "some_failed": "⚠️ Some files failed to process. Fix the errors above and try again.",
    ...
    "ja": {
        ...
        "upload": {
            ...
            "error_too_many_files": "⚠️ 一度にアップロードできるCSVファイルは{max_files}件までです。",
            "error_file_too_large": "⚠️ {max_mb} MBを超えるファイルがあります: {filenames}",
            "error_total_too_large": "⚠️ アップロード合計サイズが大きすぎます。CSV合計を{max_mb} MB未満にしてください。",
        ...
        "process": {
            ...
            "some_failed": "⚠️ 一部のファイルを処理できませんでした。上記のエラーを修正して、もう一度お試しください。",
